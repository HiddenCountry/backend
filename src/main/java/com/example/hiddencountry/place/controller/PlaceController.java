...
public class PlaceController {
	...
	public ApiResponse<PaginationModel<PlaceThumbnailModel>> getPlace(
		...
		@RequestParam(required = false) Cat1 cat1,
		...
		return ApiResponse.onSuccess(
			SuccessStatus.OK,
			placeService.getThumbnailsByFilterAndSort(
			user,page,size,cat1,contentType,season,countryRegion,sortType,latitude,longitude
		));
	}
